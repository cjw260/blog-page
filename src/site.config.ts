...
export const siteConfig = {
  ...
  url: 'https://cjw32.xyz/blog/',
  base: '/blog',

  // 站点信息 Site info
  title: 'Cain的个人网站',
  subtitle: '一位前端学习者的记录',
  description: 'Mc_Cain 的个人博客，记录前端学习、JavaScript、Vue、React 和开发实践。',
  ...
  socials: [
    { platform: 'github', url: 'https://github.com/cjw260' },
    { platform: 'website', url: 'https://cjw32.xyz/' },
    { platform: 'bilibili', url: 'https://space.bilibili.com/257464993' },
    { platform: 'gitee', url: 'https://gitee.com/cjw32' },
    { platform: 'rss', url: '/blog/rss.xml' },
  ] as SocialLink[],
